...
def test_consciousness_engine():
    ...
    try:
        ...
        print(f"  ✓ Consciousness Engine: {state.coherence:.3f} coherence")
        return True
...
def test_crypto_manager():
    ...
    try:
        ...
        print(f"  ✓ Crypto Manager: Keys generated")
        ...
        print(f"  ✓ Crypto Manager: Signing {'valid' if is_valid else 'invalid'}")
        return is_valid
    except Exception as e:
...
def test_consensus_aggregator():
    ...
    try:
        ...
        print(f"  ✓ Consensus Aggregator: {global_coherence:.3f} global coherence")
        return True
    except Exception as e:
...
def test_knowledge_base():
    ...
    try:
        ...
        if retrieved:
            print(f"  ✓ Knowledge Base: Stored and retrieved entry {cid[:8]}...")
            return True
        else:
