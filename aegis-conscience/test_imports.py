...
try:
    ...
    print("✓ Consciousness engine imported and created successfully")
except Exception as e:
...
try:
    ...
    print("✓ Crypto manager imported and created successfully")
    
    try:
        from consensus.pbft import PBFTConsensus
        pbft = PBFTConsensus("test_node", crypto)
        print("✓ PBFT consensus imported and created successfully")
    except Exception as e:
    ...
    try:
        ...
        print("✓ PBFT consensus imported and created with mock crypto successfully")
    except Exception as e:
        print(f"✗ Error importing PBFT consensus: {e}")
...
try:
    ...
    print("✓ P2P network imported and created successfully")
except Exception as e:
